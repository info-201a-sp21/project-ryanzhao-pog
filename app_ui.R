  ...
  <body>
    ...
    <main>
      ...
      <section id='sources'>
        ...
        <p>
          We added another dataset that tracks the amount of deathes from HIV from
          1990 to 2017 to see how the availability of ART (antiretroviral therapy)
...
conclusion <- tabPanel(
  ...
  HTML(
    ...
    <br>
      <br>
      Lastly, the line chart on page three shows the trends of incidences of HIV,
    death rates of HIV, and prevelance of HIV in countries globally between
    1990-2017. We are able to infer from these charts for each country that
    while there have not been decreases in incidences or prevleance of HIV
    across time, there has been a stabilization and even decrease in deaths
    for most countries across the globe. This trend is most likely due
